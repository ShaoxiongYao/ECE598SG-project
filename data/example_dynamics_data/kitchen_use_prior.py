...
if __name__ == '__main__':
    ...
    for __ in tqdm(range(500)):
        ...
        if __ % 100 == 99 and __ > 0:
            ...
            torch.save(s_ts2, "data/example_dynamics_data/kitchen/states_prior_1.pt")            
            torch.save(zs2, "data/example_dynamics_data/kitchen/skill_z_prior_1.pt")
            torch.save(s_tplusNs2, "data/example_dynamics_data/kitchen/states_prior_2.pt")        
